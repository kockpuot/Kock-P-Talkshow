...
<head>
    ...
    <title>Kock P Talkshow – Software development, Interviews, Podcasts & History</title>
...
<section class="hero">
    <div class="container">
        <h1>Real Conversations and software developmet. Bold Stories.</h1>
        <p>Interviews, software developmet, podcasts, hidden history, and community voices — all in one place.</p>
